...
interface FieldReplaceOperationProps {
...
const FieldReplaceOperation: React.FC<FieldReplaceOperationProps> = (props) => {
      ...
      {operation.field !== "" && operation.fieldType !== undefined ? (
        <>
          {[
            ...
            <>
              <TextField
                name={`${operation.id}-replacedvalue`}
                id={`${operation.id}-replacedvalue`}
                labelText="Value to search for"
                className="mt-4"
                value={operation.replacedValue ?? ""}
                textInputProps={{
                  type:
          ...
          {operation.fieldType === "Boolean" ? (
            <>
              ...
              <RadioButtonField
                name={`${operation.id}-replacedvalue`}
                id={`${operation.id}-replacedvalue-true`}
                labelText="True"
                className="mt-1"
                value="1"
                checked={operation.replacedValue === "1"}
                onChange={(event: React.ChangeEvent<HTMLInputElement>) => {
                  const newOperation = {
                    ...operation,
                    replacedValue: event.target.value,
              ...
              <RadioButtonField
                name={`${operation.id}-replacedvalue`}
                id={`${operation.id}-replacedvalue-false`}
                labelText="False"
                value="0"
                checked={operation.replacedValue === "0"}
                onChange={(event: React.ChangeEvent<HTMLInputElement>) => {
                  const newOperation = {
                    ...operation,
                    replacedValue: event.target.value,
...
export default FieldReplaceOperation;
